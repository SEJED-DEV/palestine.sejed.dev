          ...
          {figures.map((figure, i) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <h3 style={{ fontSize: '1.08rem', fontWeight: 600 }}><GlossaryText text={figure.name} /></h3>
              </div>
              <div>
                <span style={{
                  fontSize: '.78rem', fontWeight: 600, fontFamily: 'var(--font-mono)',
                  color: 'var(--accent)', background: 'var(--accent-dim)',
                  padding: '3px 12px', borderRadius: 9999, display: 'inline-block',
                }}>
                  {figure.role}
                </span>
              </div>
        ...
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: '.95rem', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 24, maxWidth: 600, marginInline: 'auto' }}>
              Biographical information sourced from Britannica, academic institutions, and verified publications.
            </p>
